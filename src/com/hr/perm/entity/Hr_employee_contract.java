...
@CEntity(controller = CtrHr_employee_contract.class)
public class Hr_employee_contract extends CJPA {
	@CFieldinfo(fieldname="con_id",iskey=true,notnull=true,caption="合同ID",datetype=Types.INTEGER)
	public CField con_id;  //合同ID
	@CFieldinfo(fieldname="con_code",codeid=87,notnull=true,caption="编码",datetype=Types.VARCHAR)
	...
	@CFieldinfo(fieldname="ispermanent",caption="是否正式员工",datetype=Types.INTEGER)
	public CField ispermanent;  //是否正式员工
	...
	public int MaxCount; //查询最大数量
     ...
     //自关联数据定义
	@CLinkFieldInfo(jpaclass = Hr_employee_contract_line.class, linkFields = { @LinkFieldItem(lfield = "con_id", mfield = "con_id") })
	public CJPALineData<Hr_employee_contract_line> hr_employee_contract_lines;
	...
	public Hr_employee_contract() throws Exception {
	}
