...
import com.hr.perm.ctr.CtrHr_employee_contract;
import com.hr.perm.ctr.CtrHr_employee_contract_change;

import java.sql.Types;

@CEntity(controller = CtrHr_employee_contract_change.class)
public class Hr_employee_contract_change extends CJPA {
	@CFieldinfo(fieldname="conchange_id",iskey=true,notnull=true,caption="变更合同ID",datetype=Types.INTEGER)
	public CField conchange_id;  //变更合同ID
	...
	@CFieldinfo(fieldname="changereason",notnull=true,caption="变更原因",datetype=Types.VARCHAR)
	public CField changereason;  //变更原因
	@CFieldinfo(fieldname="changetime",notnull=true,caption="变更时间",datetype=Types.TIMESTAMP)
	public CField changetime;  //变更时间
	...
	public Hr_employee_contract_change() throws Exception {
	}
