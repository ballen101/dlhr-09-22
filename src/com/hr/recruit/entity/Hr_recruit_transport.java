...
@CEntity(controller=COHr_recruit_transport.class)
public class Hr_recruit_transport extends CJPA {
	@CFieldinfo(fieldname="recruit_transport_id",iskey=true,notnull=true,precision=20,scale=0,caption="输送机构ID",datetype=Types.INTEGER)
	public CField recruit_transport_id;  //输送机构ID
	@CFieldinfo(fieldname="recruit_transport_code",precision=133,scale=0,caption="输送机构编码",datetype=Types.VARCHAR)
	public CField recruit_transport_code;  //输送机构编码
	@CFieldinfo(fieldname="recruit_transport_name",precision=341,scale=0,caption="输送机构名称",datetype=Types.VARCHAR)
	public CField recruit_transport_name;  //输送机构名称
	...
	@CFieldinfo(fieldname="recruit_transport_stat",precision=26,scale=0,caption="输送机构状态",datetype=Types.VARCHAR)
	public CField recruit_transport_stat;  //输送机构状态
	...
	public Hr_recruit_transport() throws Exception {
	}
