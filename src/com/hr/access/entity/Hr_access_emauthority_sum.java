...
@CEntity()
public class Hr_access_emauthority_sum extends CJPA {
	@CFieldinfo(fieldname = "emauthority_sum_id", iskey = true, notnull = true, caption = "员工门禁权限统计ID", datetype = Types.INTEGER)
	public CField emauthority_sum_id; // 员工门禁权限统计ID
	...
	public CField attribute1; // attribute1 清卡时写入标记字段“Y”
	...
	public Hr_access_emauthority_sum() throws Exception {
	}
