...
@CEntity(caption="岗位津贴明细")
public class Hr_salary_postsub_line extends CJPA {
	@CFieldinfo(fieldname="psl_id",iskey=true,notnull=true,precision=20,scale=0,caption="岗位补贴申请明细ID",datetype=Types.INTEGER)
	public CField psl_id;  //岗位补贴申请明细ID
	@CFieldinfo(fieldname="ps_id",notnull=true,precision=20,scale=0,caption="岗位补贴申请ID",datetype=Types.INTEGER)
	...
	@CFieldinfo(fieldname="opostsub",precision=6,scale=2,caption="原岗位津贴",datetype=Types.DECIMAL)
	public CField opostsub;  //原岗位津贴
	@CFieldinfo(fieldname="npostsub",precision=6,scale=2,caption="申请津贴",datetype=Types.DECIMAL)
	public CField npostsub;  //申请津贴
	...
	public Hr_salary_postsub_line() throws Exception {
	}
