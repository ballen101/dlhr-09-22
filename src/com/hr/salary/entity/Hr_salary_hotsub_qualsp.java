...
@CEntity(caption="高温补贴资格内职位",tablename="Hr_salary_hotsub_qualsp")
public class Hr_salary_hotsub_qualsp extends CJPA {
	@CFieldinfo(fieldname ="hsqsp_id",iskey=true,notnull=true,precision=20,scale=0,caption="高温补贴资格申请ID",datetype=Types.INTEGER)
	public CField hsqsp_id;  //高温补贴资格申请ID
	...
	public Hr_salary_hotsub_qualsp() throws Exception {
	}
