...
@CEntity(caption="岗位津贴申请",controller=CtrHr_salary_postsub.class)
public class Hr_salary_postsub extends CJPA {
	@CFieldinfo(fieldname="ps_id",iskey=true,notnull=true,precision=20,scale=0,caption="岗位补贴申请ID",datetype=Types.INTEGER)
	public CField ps_id;  //岗位补贴申请ID
	@CFieldinfo(fieldname="ps_code",notnull=true,codeid=129,precision=16,scale=0,caption="岗位补贴申请编码",datetype=Types.VARCHAR)
	public CField ps_code;  //岗位补贴申请编码
	@CFieldinfo(fieldname="substype",notnull=true,precision=1,scale=0,caption="津贴类型",defvalue="4",datetype=Types.INTEGER)
	...
	@CFieldinfo(fieldname="startdate",precision=19,scale=0,caption="开始月份",datetype=Types.TIMESTAMP)
	public CField startdate;  //开始月份
	@CFieldinfo(fieldname="enddate",precision=19,scale=0,caption="结束月份",datetype=Types.TIMESTAMP)
	public CField enddate;  //结束月份
	@CFieldinfo(fieldname="appreason",precision=512,scale=0,caption="申请原因",datetype=Types.VARCHAR)
	...
	@CLinkFieldInfo(jpaclass = Hr_salary_postsub_line.class, linkFields = { @LinkFieldItem(lfield = "ps_id", mfield = "ps_id") })
	public CJPALineData<Hr_salary_postsub_line> hr_salary_postsub_lines;

	public Hr_salary_postsub() throws Exception {
	}
