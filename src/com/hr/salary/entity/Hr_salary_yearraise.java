...
import com.hr.salary.ctr.CtrHr_salary_yearraise;

import java.sql.Types;

@CEntity(caption="年度调薪单",tablename="Hr_salary_yearraise",controller=CtrHr_salary_yearraise.class)
public class Hr_salary_yearraise extends CJPA {
	@CFieldinfo(fieldname ="yrid",iskey=true,notnull=true,precision=20,scale=0,caption="年度调薪ID",datetype=Types.INTEGER)
	public CField yrid;  //年度调薪ID
	@CFieldinfo(fieldname ="yrcode",notnull=true,codeid=134,precision=15,scale=0,caption="年度调薪编码",datetype=Types.VARCHAR)
	public CField yrcode;  //年度调薪编码
	...
	@CFieldinfo(fieldname ="ttsachag",precision=10,scale=2,caption="调薪金额合计",datetype=Types.DECIMAL)
	public CField ttsachag;  //调薪金额合计
	@CFieldinfo(fieldname ="yrqname",precision=128,scale=0,caption="名称",datetype=Types.VARCHAR)
	public CField yrqname;  //名称
	@CFieldinfo(fieldname ="yrqid",precision=20,scale=0,caption="年度调薪机构额度维护ID",datetype=Types.INTEGER)
	public CField yrqid;  //年度调薪机构额度维护ID
	@CFieldinfo(fieldname ="qutaorgs",precision=32,scale=0,caption="年度调薪额度机构id",datetype=Types.VARCHAR)
	public CField qutaorgs;  //年度调薪额度机构id
	public String SqlWhere; //查询附加条件
	public int MaxCount; //查询最大数量

     //自关联数据定义
	@CLinkFieldInfo(jpaclass = Hr_salary_yearraise_line.class, linkFields = { @LinkFieldItem(lfield = "yrid", mfield = "yrid") })
	public CJPALineData<Hr_salary_yearraise_line> hr_salary_yearraise_lines;
	...
	public Hr_salary_yearraise() throws Exception {
	}
