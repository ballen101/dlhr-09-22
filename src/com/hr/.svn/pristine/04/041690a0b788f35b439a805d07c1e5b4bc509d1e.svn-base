...
import com.hr.perm.ctr.CtrHr_employee_contract_relieve;

import java.sql.Types;

@CEntity(controller = CtrHr_employee_contract_relieve.class)
public class Hr_employee_contract_relieve extends CJPA {
	@CFieldinfo(fieldname="conrl_id",iskey=true,notnull=true,caption="解除合同ID",datetype=Types.INTEGER)
	public CField conrl_id;  //解除合同ID
	@CFieldinfo(fieldname="con_id",notnull=true,caption="合同ID",datetype=Types.INTEGER)
	public CField con_id;  //合同ID
	@CFieldinfo(fieldname="con_code",notnull=true,caption="编码",datetype=Types.VARCHAR)
	public CField con_code;  //编码
	...
	@CFieldinfo(fieldname="relievereason",notnull=true,caption="解除原因",datetype=Types.VARCHAR)
	public CField relievereason;  //解除原因
	@CFieldinfo(fieldname="relievetime",notnull=true,caption="解除时间",datetype=Types.TIMESTAMP)
	public CField relievetime;  //解除时间
	@CFieldinfo(fieldname="compensate",caption="补偿金额",datetype=Types.DECIMAL)
	public CField compensate;  //补偿金额
	@CFieldinfo(fieldname="compensatedesc",caption="补偿内容描述",datetype=Types.VARCHAR)
	public CField compensatedesc;  //补偿内容描述
	...
	public Hr_employee_contract_relieve() throws Exception {
	}
