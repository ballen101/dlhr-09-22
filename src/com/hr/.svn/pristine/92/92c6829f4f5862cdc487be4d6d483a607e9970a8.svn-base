...
import com.hr.salary.ctr.CtrHr_salary_techsub_cancel;

import java.sql.Types;

@CEntity(caption="技术津贴中止",tablename="Hr_salary_techsub_cancel",controller=CtrHr_salary_techsub_cancel.class)
public class Hr_salary_techsub_cancel extends CJPA {
	@CFieldinfo(fieldname ="tsc_id",iskey=true,notnull=true,precision=20,scale=0,caption="技术津贴中止ID",datetype=Types.INTEGER)
	public CField tsc_id;  //技术津贴中止ID
	@CFieldinfo(fieldname ="tsc_code",notnull=true,codeid=135,precision=16,scale=0,caption="技术津贴中止编码",datetype=Types.VARCHAR)
	public CField tsc_code;  //技术津贴中止编码
	@CFieldinfo(fieldname ="canceldate",notnull=true,precision=10,scale=0,caption="中止月份",datetype=Types.DATE)
	public CField canceldate;  //中止月份
	@CFieldinfo(fieldname ="cancelreason",notnull=true,precision=512,scale=0,caption="中止原因",datetype=Types.VARCHAR)
	public CField cancelreason;  //中止原因
	...
	@CFieldinfo(fieldname ="subsdate",notnull=true,precision=10,scale=0,caption="生效月份",datetype=Types.DATE)
	...
	@CFieldinfo(fieldname ="tsl_id",precision=20,scale=0,caption="技术津贴明细ID",datetype=Types.INTEGER)
	...
	public Hr_salary_techsub_cancel() throws Exception {
	}
