...
@CEntity(caption="批量特殊调薪明细单",tablename="Hr_salary_specchgsa_batch_line")
public class Hr_salary_specchgsa_batch_line extends CJPA {
	@CFieldinfo(fieldname ="scsblid",iskey=true,notnull=true,precision=20,scale=0,caption="批量特殊调薪明细ID",datetype=Types.INTEGER)
	public CField scsblid;  //批量特殊调薪明细ID
	@CFieldinfo(fieldname ="scsbid",notnull=true,precision=20,scale=0,caption="批量特殊调薪ID",datetype=Types.INTEGER)
	...
	@CFieldinfo(fieldname ="oldattendtype",precision=1,scale=0,caption="出勤机制",datetype=Types.INTEGER)
	public CField oldattendtype;  //出勤机制
	@CFieldinfo(fieldname ="oldchecklev",precision=1,scale=0,caption="绩效考核层级",datetype=Types.INTEGER)
	...
	@CFieldinfo(fieldname ="newattendtype",precision=1,scale=0,caption="出勤机制",datetype=Types.INTEGER)
	public CField newattendtype;  //出勤机制
	@CFieldinfo(fieldname ="newchecklev",precision=1,scale=0,caption="绩效考核层级",datetype=Types.INTEGER)
	...
	public Hr_salary_specchgsa_batch_line() throws Exception {
	}
