...
public class Hr_recruit_formex extends CJPA {

	@CFieldinfo(fieldname = "recruit_id", notnull = true, caption = "recruit_id", datetype = Types.INTEGER)
	public CField recruit_id; // entry_id
	@CFieldinfo(fieldname = "recruit_code", notnull = true, caption = "recruit_code", datetype = Types.VARCHAR)
	public CField recruit_code; // entry_code
	...
	public Hr_recruit_formex() throws Exception {
	}
