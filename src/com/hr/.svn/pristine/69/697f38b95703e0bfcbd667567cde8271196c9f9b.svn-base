...
@CEntity()
public class Hrkq_workschmonthlist extends CJPA {
	@CFieldinfo(fieldname = "wklistid", iskey = true, notnull = true, caption = "LID", datetype = Types.INTEGER)
	public CField wklistid; // LID
	...
	@CFieldinfo(fieldname = "wklid", caption = "排班单行ID", datetype = Types.INTEGER)
	public CField wklid; // 排班单行ID
	public String SqlWhere; // 查询附加条件
	public int MaxCount; // 查询最大数量

	// 自关联数据定义

	public Hrkq_workschmonthlist() throws Exception {
	}
