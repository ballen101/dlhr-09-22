...
import com.hr.perm.ctr.CtrHr_leavejob_cancel;

import java.sql.Types;

@CEntity(controller = CtrHr_leavejob_cancel.class)
public class Hr_leavejob_cancel extends CJPA {
	@CFieldinfo(fieldname = "ljcid", iskey = true, notnull = true, caption = "离职撤销ID", datetype = Types.INTEGER)
	public CField ljcid; // 离职撤销ID
	@CFieldinfo(fieldname = "ljccode", codeid = 65, notnull = true, caption = "离职撤销编码", datetype = Types.VARCHAR)
	public CField ljccode; // 离职撤销编码
	...
	@CFieldinfo(fieldname = "ljcdate", notnull = true, caption = "撤销日期", datetype = Types.TIMESTAMP)
	public CField ljcdate; // 撤销日期
	...
	@CFieldinfo(fieldname = "ljcreason", caption = "撤销原因", datetype = Types.VARCHAR)
	public CField ljcreason; // 撤销原因
	...
	public Hr_leavejob_cancel() throws Exception {
	}
