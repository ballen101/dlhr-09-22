...
@CEntity(controller = COHr_ykt_card_clean.class)
public class Hr_ykt_card_clean extends CJPA {
	@CFieldinfo(fieldname = "card_clean_id", iskey = true, notnull = true, caption = "清卡单ID", datetype = Types.INTEGER)
	public CField card_clean_id; // 清卡单ID
	@CFieldinfo(fieldname = "card_clean_no", codeid = 115, caption = "清卡单号", datetype = Types.VARCHAR)
	public CField card_clean_no; // 清卡单号
	@CFieldinfo(fieldname = "card_id", notnull = true, caption = "卡ID", datetype = Types.INTEGER)
	...
	@CFieldinfo(fieldname = "clean_date", caption = "清卡时间", datetype = Types.TIMESTAMP)
	public CField clean_date; // 清卡时间
	@CFieldinfo(fieldname = "clean_reason", caption = "清卡原因", datetype = Types.VARCHAR)
	public CField clean_reason; // 清卡原因
	...
	public Hr_ykt_card_clean() throws Exception {
	}
