...
@CEntity(caption="高温补贴资格申请",controller=CtrHr_salary_hotsub_qual.class)
public class Hr_salary_hotsub_qual extends CJPA {
	@CFieldinfo(fieldname="hsq_id",iskey=true,notnull=true,precision=20,scale=0,caption="高温补贴资格申请ID",datetype=Types.INTEGER)
	public CField hsq_id;  //高温补贴资格申请ID
	@CFieldinfo(fieldname="hsq_code",notnull=true,codeid=126,precision=16,scale=0,caption="高温补贴资格申请编码",datetype=Types.VARCHAR)
	public CField hsq_code;  //高温补贴资格申请编码
	...
	@CLinkFieldInfo(jpaclass = Hr_salary_hotsub_qual_line.class, linkFields = { @LinkFieldItem(lfield = "hsq_id", mfield = "hsq_id") })
	public CJPALineData<Hr_salary_hotsub_qual_line> hr_salary_hotsub_qual_lines;

	public Hr_salary_hotsub_qual() throws Exception {
	}
