...
import com.hr.attd.ctr.CtrHrkq_overtime_qual_break;

import java.sql.Types;

@CEntity(controller = CtrHrkq_overtime_qual_break.class)
public class Hrkq_overtime_qual_break extends CJPA {
	@CFieldinfo(fieldname = "oqb_id", iskey = true, notnull = true, caption = "终止ID", datetype = Types.INTEGER)
	public CField oqb_id; // 终止ID
	@CFieldinfo(fieldname = "oqb_code", codeid = 91, notnull = true, caption = "终止编码", datetype = Types.VARCHAR)
	public CField oqb_code; // 终止编码
	@CFieldinfo(fieldname = "over_reason", caption = "终止原因", datetype = Types.VARCHAR)
	public CField over_reason; // 终止原因
	@CFieldinfo(fieldname = "oqbs_date", caption = "终止时间", datetype = Types.TIMESTAMP)
	public CField oqbs_date; // 终止时间
	@CFieldinfo(fieldname = "oql_id", notnull = true, caption = "加班资格行ID", datetype = Types.INTEGER)
	...
	@CFieldinfo(fieldname = "oq_code", caption = "加班资格申请编码", datetype = Types.VARCHAR)
	...
	public Hrkq_overtime_qual_break() throws Exception {
	}
