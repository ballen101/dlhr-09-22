...
import com.hr.perm.ctr.CtrHr_empptjob_break;

import java.sql.Types;

@CEntity(controller = CtrHr_empptjob_break.class)
public class Hr_empptjob_break extends CJPA {
	@CFieldinfo(fieldname = "ptjbid", iskey = true, notnull = true, caption = "兼职终止", datetype = Types.INTEGER)
	public CField ptjbid; // 兼职终止
	@CFieldinfo(fieldname = "ptjbcode", codeid = 90, notnull = true, caption = "兼职编码", datetype = Types.VARCHAR)
	public CField ptjbcode; // 兼职编码
	@CFieldinfo(fieldname = "ptjaid", notnull = true, caption = "兼职申请ID", datetype = Types.INTEGER)
	public CField ptjaid; // 兼职申请ID
	@CFieldinfo(fieldname = "ptjacode", notnull = true, caption = "兼职申请编码", datetype = Types.VARCHAR)
	public CField ptjacode; // 兼职申请编码
	@CFieldinfo(fieldname = "ptbappdate", notnull = false, caption = "终止申请时间", datetype = Types.TIMESTAMP)
	public CField ptbappdate; // 终止申请时间
	@CFieldinfo(fieldname = "ptbbdate", notnull = true, caption = "终止日期", datetype = Types.TIMESTAMP)
	public CField ptbbdate; // 终止日期
	@CFieldinfo(fieldname = "breakreason", caption = "提前终止原因", datetype = Types.VARCHAR)
	public CField breakreason; // 提前终止原因
	...
	@CFieldinfo(fieldname = "ptjatype", caption = "兼职范围 1内部调用 2 跨单位 3 跨模块/制造群", datetype = Types.INTEGER)
	...
	@CFieldinfo(fieldname = "odorghrlev", notnull = true, caption = "主职部门人事级别", defvalue = "0", datetype = Types.INTEGER)
	...
	@CFieldinfo(fieldname = "odattendtype", caption = "主职出勤类别", datetype = Types.INTEGER)
	...
	@CFieldinfo(fieldname = "neworghrlev", notnull = true, caption = "兼职部门人事级别", defvalue = "0", datetype = Types.INTEGER)
	...
	@CFieldinfo(fieldname = "newattendtype", caption = "兼职出勤类别", datetype = Types.INTEGER)
	...
	public Hr_empptjob_break() throws Exception {
	}
