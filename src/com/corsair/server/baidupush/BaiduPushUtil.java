package com.corsair.server.baidupush;
...
public class BaiduPushUtil {
	...
	public String push_msg(String user_id, String channel_id, String title, String description) {
		...
		// 访问令牌
		String apikey = "9dEeoLBYsAIEjtmcnrABkMvG";
		// 密匙
		String secret = "u4e3NEsQuEz4DGI6eclT8F5d0CtGyFEk";
		// 推送类型，取值范围为：1～3
		...
		String responseStr = postdata(url, parameters);
		return responseStr;
	}
	...
	private String postdata(String url, Map<String, String> parameters) {
		...
		// str = new String(post.getResponseBodyAsString().getBytes("utf-8"));
		// } catch (Exception e) {
	...
	public static void main(String[] args) {
		...
		System.out.println(new BaiduPushUtil().push_msg("5691882609019184333", "893314637201712245", "推送成功", "推送成功"));
	}
}